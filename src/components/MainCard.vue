<template>
  <header>
    <div class="logo-container">
      <img src="../assets/starspirits.png" alt="Logo" />
    </div>
  </header>
  <body>
    <div class="wrapper">
        ...
        <div class="container-one">
          ...
          <div class="social-link">
            ...
            <div class="link">
              <img src="" alt="" />
              <a
                href="https://www.instagram.com/monofactor974/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
...
export default {
  data() {
    return {
      message: "Ceci est un exemple de message dans un composant Vue.js.",
    };
  },
};
...
header {
  background-color: black; /* Couleur de fond de l'en-tête */
...
.logo-container {
  margin-top: 10px; /* Marge pour espacer le logo du haut */
  margin-bottom: 10px;
}

.logo-container img {
  max-height: 100%; /* Assurez-vous que le logo ne dépasse pas la hauteur de l'en-tête */
  max-width: 100px; /* Définir une largeur maximale pour le logo */
  height: auto;
  border-radius: 50px;
}
img {
...
.profile {
  position: relative;
  display: inline-block; /* Permet à l'icône d'être positionnée par rapport à l'image */
  padding: 15px;
  margin: 15px;
}
.zoom-icon {
  ...
  width: 40px;
  height: 40px;
  background-image: url("../assets/loupe.svg"); /* Chemin vers votre icône de zoom */
  background-size: cover;
  opacity: 0; /* Initialement invisible */
  transition: opacity 0.3s ease;
}

.profile:hover .zoom-icon {
  opacity: 1; /* Afficher l'icône lors du survol de l'image */
}
.profile img {
  object-fit: cover; /* Ajuste l'image pour remplir son conteneur tout en conservant ses proportions */
  border-radius: 15%; /* Pour conserver les coins arrondis et obtenir un effet de cercle */
...
.profile-img.zoomed {
  transform: scale(1.7); /* Zoom sur l'image à 120% de sa taille d'origine */
}
.link svg {
  height: 4rem;
  margin: 15px;
